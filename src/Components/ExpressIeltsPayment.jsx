  ...
  return (
    <div>
      ...
      <div className="lg:shadow-md lg:rounded-2xl pt-10 lg:p-10 max-w-[1000px]">
        <div className="px-10">
            <h1 className="text-2xl font-bold text-center py-5 ">Express Ielts Training Payment</h1>
        </div>
        ...
        <section className="flex lg:justify-end justify-center order-1 lg:order-2">
          <div className="max-w-[350px]">
            <div className="bg-zinc-300 rounded-t-xl ">
              ...
              <h1 className="font-bold text-center pb-2">Express Ielts Training</h1>
...
export default ExpressIeltsPayment;
