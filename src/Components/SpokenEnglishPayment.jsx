  ...
  return (
    <div>
      ...
      <div className="lg:shadow-md lg:rounded-2xl pt-10 lg:p-10 max-w-[1000px]">
        <div className="px-10">
            <h1 className="text-2xl font-bold text-center py-5 ">Spoken English Course Payment</h1>
        </div>
        ...
        <section className="flex lg:justify-end justify-center order-1 lg:order-2">
          <div className="max-w-[350px]">
            <div className="bg-zinc-300 rounded-t-xl ">
              <div className="p-5">
                <img src="/cp3.png" alt="" className="w-full rounded-xl" />
              </div>
              <h1 className="font-bold text-center pb-2">Spoken English Course</h1>
            ...
            <div className="bg-zinc-300 rounded-b-xl mt-0.5">
              <div className="flex p-5 justify-between">
                ...
                <h1 className="text-2xl"> &#8377;17,999</h1>
              </div>
...
export default SpokenEnglishPayment;
