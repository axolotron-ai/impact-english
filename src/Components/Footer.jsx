    ...
    <div>
      <main className='bg-black p-5 lg:p-10 lg:px-20 px-10 text-white mt-10'>
        <section className='grid lg:grid-cols-3 gap-10 pt-10 lg:pt-0'>
          <section className=''>
            <h1 className='text-2xl lg:text-3xl font-bold montserrat'>IMPACT ENGLISH</h1>
            <h5 className='pt-5'>Exclusive IELTS preparation and Training Institute</h5>
          </section>
          <section className=''>
            <h1 className='text-2xl lg:text-3xl font-bold montserrat'>Navigation</h1>
            <div className="grid lg:grid-cols-2 pt-5 lg:gap-5 gap-2">
              <Link href={"/"} className='opacity-70 hover:opacity-100 duration-200'>Home</Link>
              <Link href={"/#about"} className='opacity-70 hover:opacity-100 duration-200'>About us</Link>
              <Link href={"/#courses"} className='opacity-70 hover:opacity-100 duration-200'>Courses</Link>
              <Link href={"/#gallery"} className='opacity-70 hover:opacity-100 duration-200'>Achievements</Link>
              <Link href={"/#contact"} className='opacity-70 hover:opacity-100 duration-200'>Contact</Link>
            </div>
          </section>
          <section className=''>
            <h1 className='text-2xl lg:text-3xl font-bold montserrat'>Information</h1>
