    ...
    <div>
      <main className="bg-black p-5 lg:p-10 lg:px-20 px-10 text-white mt-10">
              ...
              <Link href={"mailto:enquiries.impactenglish@gmail.com"}>
                <div className="flex opacity-70 hover:opacity-100 duration-200">
                  ...
                  <div className="">
                    ...
                    <p style={{fontFamily:'sans-serif'}}>enquiries.impactenglish@gmail.com</p>
                  </div>
                </div>
              </Link>
        ...
        <section>
          ...
          <div className="flex justify-center gap-20 pt-10 text-2xl">
            <a
            ...
            <a
              href="https://www.linkedin.com/in/impact-english-477911204?utm_source=share_via&utm_content=profile&utm_medium=member_android"
              target="_blank"
            >
              <FaLinkedin />
            </a>
