  ...
  return (
    <div>
      ...
      <div className="lg:shadow-md lg:rounded-2xl pt-10 lg:p-10 max-w-[1000px]">
        <div className="px-10">
            <h1 className="text-2xl font-bold text-center py-5 ">Toefl Express Training Payment</h1>
        </div>
        ...
        <section className="flex lg:justify-end justify-center order-1 lg:order-2">
          <div className="max-w-[350px]">
            <div className="bg-zinc-300 rounded-t-xl ">
              ...
              <h1 className="font-bold text-center pb-2">Toefl Express Training</h1>
              <div className=" p-5 pt-0">
                <div className="flex justify-between">
                  <h1 className="opacity-60">Duration : </h1>
                  <h1 className="">1 Months</h1>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-zinc-300 rounded-b-xl mt-0.5">
              <div className="flex p-5 justify-between">
                ...
                <h1 className="text-2xl"> &#8377;7,999</h1>
              </div>
...
export default ToeflExpressPayment;
