    ...
    <div className="overflow-hidden">
      <div className={show ? "hidden" : "bg-black"}>
        <main className="gallerymain min-h-[100vh] flex justify-center items-center">
          ...
          >
            <h1 className="font-bold text-white lg:text-3xl text-2xl momo">
      ...
      <motion.div
                ...
                transition={{ type: "spring", stiffness: 200, damping: 50 }}
              >
      <main className={show ? "lg:block hidden" : "hidden"}>
        <DynamicGallery apiPath={'/api/gallery'} embedded={true} />
      </main>
      </motion.div>
      {/* <main
      ...
      <section className={show ? "lg:hidden" : "hidden"}>
        <DynamicGallery apiPath={'/api/gallery'} embedded={true} />
      </section>
    </div>
  );
