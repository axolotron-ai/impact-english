    ...
    <div className="min-h-[100vh] flex items-center overflow-hidden">
      <main className="grid lg:grid-cols-5">
        <section className="col-span-2 flex justify-center lg:p-20 ">
          <div className="">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, scale: 1, x: 0, y: 0 }}
              transition={{ type: "spring", stiffness: 200, damping: 50 }}
              className="lg:flex gap-5 pt-10 hidden"
            >
              <div className="">
              ...
              <div className="montserrat grid gap-5">
                ...
                <a
                  href="mailto:enquiries.impactenglish@gmail.com"
                  target="_blank"
                >
                  <div className="flex">
                    <div className="">
                    ...
                    <div className="">
                      ...
                      <p style={{fontFamily:'sans-serif' , fontWeight:400}}>enquiries.impactenglish@gmail.com</p>
                    </div>
                  </div>
                </a>
                <a
                  href="https://maps.app.goo.gl/3M8wSG8M25F57jNJ8"
                  target="_blank"
                >
                  <div className="flex">
                    <div className="">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, scale: 1, x: 0, y: 0 }}
          transition={{ type: "spring", stiffness: 200, damping: 50 }}
          className="col-span-3 lg:p-10 lg:mr-10 lg:mt-20 "
        >
          <div className="">
            <img
              src="/contactbgst.png"
